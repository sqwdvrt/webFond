...
export const charterGroups = [
  {
    title: "Люди",
    lead: "По уставу фонд вправе поддерживать людей, которым нужна помощь.",
    items: [projects[0], projects[1]],
  },
  {
    title: "Места и территории",
    lead: "По уставу фонд вправе участвовать в сохранении объектов и территорий исторического, культурного и природоохранного значения.",
    items: [projects[2]],
  },
  {
    title: "Как собираем помощь",
    lead: "По уставу фонд вправе объединять организации, привлекать пожертвования, участвовать в программах и реализовывать совместные проекты.",
